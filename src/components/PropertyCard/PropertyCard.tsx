// frontend/src/components/PropertyCard/PropertyCard.tsx
...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, index, animationType = 'vertical' }) => {
  ...
  const cardVariants = {
    hidden: animationType === 'vertical' ? { opacity: 0, y: 100 } : { opacity: 0, x: index % 2 === 0 ? -100 : 100 },
    visible: {
      opacity: 1,
      x: 0,
      y: 0,
  ...
  return (
    ...
    >
      <div className={styles.imageWrapper}>
        <img src={property.imageUrl} alt={t(property.nameKey)} className={styles.propertyImage} />
