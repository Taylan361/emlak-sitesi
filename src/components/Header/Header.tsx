...
const Header: React.FC<HeaderProps> = ({ onNavLinkClick }) => {
  ...
  const dropdownVariants = {
    ...
    exit: { opacity: 0, y: -10, scaleY: 0, originY: 0, transition: { duration: 0.2, ease: "easeIn" } }
  };
  ...
  return (
    <header className={styles.header}>
      <div className={styles.container}>
        ...
        {/* Sağ Üst İkonlar ve Dil/Para Birimi */}
        <div className={styles.rightIcons}>
          ...
          <a href="https://wa.me/905XXXXXXXXX?text=Merhaba,%20ilanlarınızla%20ilgili%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener noreferrer" className={styles.contactIcon}>
            <FaWhatsapp />
          </a>

          {/* Telefon İkonu */}
          <a href="tel:+905XXXXXXXXX" className={styles.contactIcon}>
            <FaPhoneAlt />
          </a>
          ...
          >
            <span className={styles.currentLanguage}>
              {/* Mevcut dile ait bayrak PNG'si gösteriliyor */}
              <img
